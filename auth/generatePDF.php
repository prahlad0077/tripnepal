                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            <ul class="list-unstyled">
                                ...
                                <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Tax(0%)</span>Rs. 0 </li>
                            </ul>
                            <p class="text-black float-start"><span class="text-black me-3"> Total Amount</span><span style="font-size: 25px;">Rs. <?php echo $trans_amount ?></span></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
